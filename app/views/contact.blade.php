...
<div class="row-fluid">
          ...
          <div class="span4 offset1">
            ...
            <form class="form-contact-us" method="POST" action="{{ URL::route('contact-post') }}">
              <div class="control-group">
                <div class="controls">
                  <input type="text" id="inputName" name="inputName" placeholder="Name" lab>
                </div>
              </div>
              <div class="control-group">
                <div class="controls">
              ...
              <div class="control-group">
                <div class="controls">
                  <textarea id="inputMessage" name="inputMessage" placeholder="Message"></textarea>
                </div>
              </div>
              <div class="control-group">
                <div class="controls">
